...
const css = compileString(
  "@use 'components/popup'; @use 'components/truck-camera'; @use 'components/dispatch-load-dialog'; @use 'components/fuel/plan-editor'; @use 'components/routing/route-editor'; @use 'pages/fleet-map/details';",
  {
