...
{
    public static string? Concise(string? message) => message is
        ...
        ? "Check the stop address." : message;

    public static string? For(string? message, bool hasValidRoute) => hasValidRoute && message is
        ("Route update queued." or "Route update pending."
