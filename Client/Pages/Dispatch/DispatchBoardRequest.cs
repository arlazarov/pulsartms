...
internal sealed record DispatchBoardRequest(int Page, string Search, Guid? TruckId, int View, DateOnly Date, bool Completed = false)
{
  public string Url => Completed
    ...
    + (TruckId.HasValue ? $"&truckId={TruckId}" : "")
    + (View is 1 or 2 ? "&includePlanned=true" : "");
}
