...
public class DisplayRouteGeometryTests
{
  ...
  public void DisplayOmitsOnlyGeometryForTheExactKnownPlan(bool sameId, int version, bool omitted)
  {
    var plan = new RoutePlan { Id = Guid.NewGuid(), Version = 3,
      Route = new() { Miles = 10, Legs = [new(10, 600, [new(40, -80), new(41, -80)])] },
      ReferenceRoute = new() { Legs = [new(20, 1200, [new(39, -80), new(41, -80)])] },
      Stops = [new(Guid.NewGuid(), "Stop", "Address", 1, new(41, -80))] };
    Application.Features.Routing.Services.Routes.PlanningReadService.TrimForDisplay(plan, sameId ? plan.Id : Guid.NewGuid(), version);
  ...
  {
    var points = Enumerable.Range(0, 1000).Select(i => new RoutePoint(40, -80 + i * .00001)).ToList();
  ...
  public void KeepsSmallRoadCurvesVisibleAtStreetZoom()
  {
    ...
    var points = new List<RoutePoint> { new(40, -80), new(40 + 6d / 111320, -79.999), new(40, -79.998) };
  ...
  {
    var points = new List<RoutePoint> { new(40,-80), new(40,-79.99), new(40.01,-79.99), new(40,-80) };
    Assert.Equal(points, DisplayRouteGeometry.Simplify(points));
  }
}
