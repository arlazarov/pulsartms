...
public class FuelRouteWindowTests
{
  ...
  {
    var route = new TruckRoute { Legs = [new(100, 6000, []), new(100, 12000, [])] };
  ...
  public void AlternativeShortensInboundLegWithoutInventingExtraFuel()
  {
    var profile = new TruckRouteProfile { Confirmed = true, TankGallons = 100, Mpg = 5,
      ReserveGallons = 10, FillPercent = 100, StopCostUsd = 0 };
    var candidate = new FuelCandidate(new() { StationId = Guid.NewGuid(), Name = "Bypass", YourPrice = 3 },
      100, -10, 15, 3, 3) { EntryMiles = 50, ExitMiles = 150 };
