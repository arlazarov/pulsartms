...
public sealed class DispatchAuthorizationTests
{
  ...
  [InlineData(typeof(DriverContactController), "Get", "Dispatch", true)]
  [InlineData(typeof(DriverContactController), "Update", "Dispatch", true)]
  [InlineData(typeof(DriverContactController), "Update", "Admin", true)]
