...
public sealed record FuelCandidate(FuelPlanStop Station, double AlongMiles, double ExtraInMiles,
  double ExtraOutMiles, double PriceUsd, double EconomicPriceUsd)
{
