...
public sealed class PlanningPreferences
{
  ...
  public static PlanningPreferences From(TruckRouteProfile profile) => new()
  {
    UseIfta = profile.UseIfta, MaxDetourMinutes = profile.MaxDetourMinutes,
    ReserveGallons = profile.ReserveGallons, FillPercent = profile.FillPercent,
    StopCostUsd = profile.StopCostUsd, DriverHourlyCostUsd = profile.DriverHourlyCostUsd, CadToUsd = profile.CadToUsd
  };
}
