namespace Application.Features.Shipments.Models;
...
public sealed record SaveShipment(
  Guid RequestId,
  long ExpectedRevision,
  Shipment Shipment
);

public sealed record ShipmentIssue(string Field, string Message);

public sealed record ShipmentStopOption(
  Guid Id,
  string Job,
  string Name,
  string Address,
