  ...
  : IGmailPushValidator
{
  public bool IsConfigured =>
    ...
    && !string.IsNullOrWhiteSpace(
      configuration["Gmail:PushServiceAccountEmail"]
    )
  ...
  public async Task<bool> ValidateAsync(string authorization)
  {
    ...
    try
    {
      var payload = await GoogleJsonWebSignature.ValidateAsync(
        ...
        {
          Audience = [configuration["Gmail:PushAudience"]!],
        }
      );
  ...
  public bool IsExpectedMailbox(string? email) =>
    !string.IsNullOrWhiteSpace(email)
    && string.Equals(
      email,
      configuration["Gmail:MailboxEmail"],
      StringComparison.OrdinalIgnoreCase
    );
}
