...
public class GmailWatchService(GmailServiceFactory gmailServiceFactory) : IGmailWatchService
{
  public async Task<GmailWatchResult> StartAsync(CancellationToken cancellationToken = default)
  {
    ...
    var response = await gmail.Users.Watch(request, "me").ExecuteAsync(cancellationToken);
