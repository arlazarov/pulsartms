...
namespace Infrastructure.Persistence.Migrations
{
  ...
  public partial class InitialCreate : Migration
  {
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
      ...
      migrationBuilder.CreateTable(
        name: "FuelImportSources",
        columns: table => new
        {
          Id = table.Column<Guid>(type: "uuid", nullable: false),
          GmailMessageId = table.Column<string>(
            type: "character varying(255)",
            maxLength: 255,
            nullable: false
          ),
          AttachmentName = table.Column<string>(
            type: "character varying(500)",
            maxLength: 500,
            nullable: false
          ),
          ImportedAt = table.Column<DateTime>(
            type: "timestamp with time zone",
            nullable: false
          ),
        },
        constraints: table =>
        {
          table.PrimaryKey("PK_FuelImportSources", x => x.Id);
        }
      );
      ...
      migrationBuilder.CreateTable(
        ...
        columns: table => new
        {
          ...
          DiscountPrice = table.Column<decimal>(
            type: "numeric",
            nullable: false
          ),
        ...
        constraints: table =>
        {
          table.PrimaryKey("PK_FuelDiscounts", x => x.Id);
          table.ForeignKey(
            name: "FK_FuelDiscounts_FuelStations_FuelStationId",
      ...
      migrationBuilder.CreateTable(
        ...
        columns: table => new
        {
          Id = table.Column<Guid>(type: "uuid", nullable: false),
          FuelStationId = table.Column<Guid>(type: "uuid", nullable: false),
          ExternalTransactionId = table.Column<string>(
            type: "character varying(100)",
            maxLength: 100,
            nullable: false
          ),
          TruckNumber = table.Column<string>(
            type: "character varying(50)",
            maxLength: 50,
            nullable: false
          ),
      ...
      migrationBuilder.CreateIndex(
        name: "IX_FuelDiscounts_FuelStationId_EffectiveFrom_EffectiveTo",
        table: "FuelDiscounts",
        columns: new[] { "FuelStationId", "EffectiveFrom", "EffectiveTo" }
      );
      ...
      migrationBuilder.CreateIndex(
        name: "IX_FuelStations_ExternalId",
        table: "FuelStations",
        column: "ExternalId"
      );

      migrationBuilder.CreateIndex(
        name: "IX_FuelTransactions_ExternalTransactionId",
        table: "FuelTransactions",
        column: "ExternalTransactionId"
      );

      migrationBuilder.CreateIndex(
        name: "IX_FuelTransactions_FuelStationId_TransactionDate",
        table: "FuelTransactions",
        columns: new[] { "FuelStationId", "TransactionDate" }
      );
    ...
    protected override void Down(MigrationBuilder migrationBuilder)
    {
      ...
      migrationBuilder.DropTable(name: "FuelDiscounts");

      migrationBuilder.DropTable(name: "FuelImportSources");
