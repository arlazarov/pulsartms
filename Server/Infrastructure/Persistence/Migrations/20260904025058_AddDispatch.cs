...
namespace Infrastructure.Persistence.Migrations
{
  ...
  public partial class AddDispatch : Migration
  {
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
      ...
      migrationBuilder.CreateTable(
        ...
        columns: table => new
        {
          ...
          CarrierName = table.Column<string>(
            type: "character varying(200)",
            maxLength: 200,
            nullable: false
          ),
          ...
          TrailerNumber = table.Column<string>(
            type: "character varying(50)",
            maxLength: 50,
            nullable: false
          ),
      ...
      migrationBuilder.CreateTable(
        ...
        columns: table => new
        {
          ...
          CoDriverName = table.Column<string>(
            type: "character varying(200)",
            maxLength: 200,
            nullable: false
          ),
          ...
          Commodity = table.Column<string>(
            type: "character varying(500)",
            maxLength: 500,
            nullable: false
          ),
          Notes = table.Column<string>(type: "text", nullable: false),
          StopNo = table.Column<string>(
            type: "character varying(100)",
            maxLength: 100,
            nullable: false
          ),
          ...
          WeightUnit = table.Column<string>(
            type: "character varying(20)",
            maxLength: 20,
            nullable: false
          ),
          Pieces = table.Column<decimal>(
            type: "numeric(18,2)",
            precision: 18,
            scale: 2,
            nullable: true
          ),
          Pallets = table.Column<decimal>(
            type: "numeric(18,2)",
            precision: 18,
            scale: 2,
            nullable: true
          ),
          Temperature = table.Column<string>(
            type: "character varying(50)",
            maxLength: 50,
            nullable: false
          ),
          TemperatureUnit = table.Column<string>(
            type: "character varying(20)",
            maxLength: 20,
            nullable: false
          ),
    ...
    {
      migrationBuilder.DropTable(name: "DispatchStops");
