...
namespace Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260923144550_SeparateTrailerCatalogFromAssignment")]
    partial class SeparateTrailerCatalogFromAssignment
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Dispatch.DispatchSettings", b =>
                {
                    ...
                    b.Property<bool>("AutomaticFuelSending")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("Domain.Entities.Fleet.Driver", b =>
                {
                    ...
                    b.Property<DateTime?>("ContactChangedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("ContactChangedBy")
                        .HasMaxLength(200)
                        .HasColumnType("character varying(200)");
            ...
            modelBuilder.Entity("Domain.Entities.Fleet.Truck", b =>
                {
                    ...
                    b.Property<Guid?>("TelemetryTrailerId")
                        .HasColumnType("uuid");

                    b.Property<bool>("TelemetryTrailerKnown")
                        .HasColumnType("boolean");

                    b.Property<Guid?>("TrailerConflictId")
                        .HasColumnType("uuid");

                    b.Property<Guid?>("TrailerId")
                        .HasColumnType("uuid");

                    b.Property<string>("TrailerSource")
                        .HasMaxLength(32)
                        .HasColumnType("character varying(32)");
                    ...
                    b.HasIndex("TelemetryTrailerId");

                    b.HasIndex("TrailerConflictId");
            ...
            modelBuilder.Entity("Domain.Entities.Fuel.FuelVisitSend", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("CompanyId", "TruckId", "ScopeId", "AssignmentRevision", "StationId", "BeforeStopId", "Content")
                        .IsUnique();

                    b.ToTable("FuelVisitSends", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Entities.Fleet.Truck", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Fleet.Trailer", null)
                        .WithMany()
                        .HasForeignKey("TelemetryTrailerId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("Domain.Entities.Fleet.Trailer", "TrailerConflict")
                        .WithMany()
                        .HasForeignKey("TrailerConflictId")
                        .OnDelete(DeleteBehavior.SetNull);
