...
namespace Infrastructure.Persistence.Migrations
{
    ...
    [Migration("20260914031300_FinishSwitchAndAutomaticMileage")]
    partial class FinishSwitchAndAutomaticMileage
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Entities.Execution.ExecutionVisit", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("SourceDispatchStopId");

                    b.HasIndex("TripId");

                    b.ToTable("ExecutionVisits");
                });
            ...
            modelBuilder.Entity("Domain.Entities.Execution.SwitchParticipant", b =>
                {
                    ...
                    b.HasIndex("ReceiveVisitId");

                    b.HasIndex("ReleaseVisitId");
            ...
            modelBuilder.Entity("Domain.Entities.Execution.ExecutionVisit", b =>
                {
                    b.HasOne("Domain.Entities.Execution.Trip", null)
                        .WithMany()
                        .HasForeignKey("TripId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
            ...
            modelBuilder.Entity("Domain.Entities.Execution.SwitchParticipant", b =>
                {
                    ...
                    b.HasOne("Domain.Entities.Execution.ExecutionVisit", null)
                        .WithMany()
                        .HasForeignKey("ReceiveVisitId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Domain.Entities.Execution.ExecutionVisit", null)
                        .WithMany()
                        .HasForeignKey("ReleaseVisitId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
