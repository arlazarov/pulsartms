...
public static class FuelWorkSignature
{
  ...
  public static string StopSignature(IWorkFacts load)
  {
  ...
  public static string LegacyStopSignature(IWorkFacts load) =>
  ...
  public static string ItinerarySignature(IEnumerable<IWorkFacts> loads) =>
    StopCompletionIdentity.Revise(
      Convert.ToHexString(
        SHA256.HashData(
          Encoding.UTF8.GetBytes(
